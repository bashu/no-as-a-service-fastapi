...
16. **[No-as-a-Service - LaunchBar Extension](https://github.com/bashu/no-as-a-service-launchbar)**
    Get a random, polite (or witty) way to say "no" from No-as-a-Service, right from LaunchBar.
